...
net.Receive( "open_airdrop_menu1", function()
...
if self:GetNWBool('ammo_color1') == false then

color1 = Color(219, 35, 69)
end

if self:GetNWBool('ammo_color1') == true then
...
ammodesc:SetFont("Describe Font")
ammodesc:SetText(self:GetNWString('ammo_statuss1'))
...
if self:GetNWBool('armor_color1') == false then

color1a = Color(219, 35, 69)
end

if self:GetNWBool('armor_color1') == true then
...
armorstat:SetText(self:GetNWString('armor_statuss1'))
...
if self:GetNWBool('medic_color1') == false then

color1aa = Color(219, 35, 69)
end

if self:GetNWBool('medic_color1') == true then
...
medicstat:SetText(self:GetNWString('medic_statuss1'))
...
if self:GetNWBool('weapon_color1') == false then

color1aaa = Color(219, 35, 69)
end

if self:GetNWBool('weapon_color1') == true then
...
weaponstat:SetText(self:GetNWString('weapon_statuss1'))
